---
description: Briefing diário do cérebro
argument-hint: "[contexto opcional]"
---
Comando `/daily-briefing` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="daily_briefing".

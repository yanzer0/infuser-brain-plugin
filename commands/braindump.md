---
description: Captura um despejo de pensamento livre, organiza no cérebro e conecta às notas existentes
argument-hint: "[contexto opcional]"
---
Comando `/braindump` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="braindump".

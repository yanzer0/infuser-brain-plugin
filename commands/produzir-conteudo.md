---
description: Pipeline de produção de conteúdo (orquestrador): gera as ideias, cadastra TODAS como cards pendentes na aba Conteúdos, desenvolve cada peça com a skill certa...
argument-hint: "[contexto opcional]"
---
Comando `/produzir-conteudo` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="produzir_conteudo".

---
description: Captura uma ideia no depot de ideias, pesquisa o mercado e ranqueia pela adequação ao momento da empresa
argument-hint: "[contexto opcional]"
---
Comando `/salvar-ideia` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="salvar_ideia".

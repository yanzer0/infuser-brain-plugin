---
description: Produz qualquer ENTREGÁVEL visual na identidade Infuser (HTML, deck, landing, mockup, documento, 'isso em HTML')
argument-hint: "[contexto opcional]"
---
Comando `/peca-visual` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="peca_visual".

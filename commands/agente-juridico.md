---
description: Orquestrador jurídico end-to-end da Infuser: roteia e executa o trabalho jurídico inteiro num pedido só - contrato novo, revisão de contrato único, parecer s...
argument-hint: "[contexto opcional]"
---
Comando `/agente-juridico` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="agente_juridico".

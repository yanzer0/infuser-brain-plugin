---
description: Refina um entregável no loop adversarial gerar → avaliar → refinar, com um avaliador cético e separado, até bater o limite de qualidade ou estabilizar
argument-hint: "[contexto opcional]"
---
Comando `/gan-loop` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="gan_loop".

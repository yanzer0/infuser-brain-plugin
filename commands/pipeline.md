---
description: Monta o dashboard do pipeline comercial: visão completa e acionável dos clientes/prospects (status, MRR, alertas, quem precisa de atenção primeiro)
argument-hint: "[contexto opcional]"
---
Comando `/pipeline` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="pipeline".

---
description: Orquestrador único de UI/UX end-to-end (UI Studio): entrevista → stack → arsenal de design → build → QA → entrega
argument-hint: "[contexto opcional]"
---
Comando `/criar-ui` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="criar_ui".

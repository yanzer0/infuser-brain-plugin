---
description: Gera roteiro de vídeo longo pra YouTube (8-20min, formato autoridade/educação)
argument-hint: "[contexto opcional]"
---
Comando `/youtube-roteiro` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="youtube_roteiro".

---
description: Gera carrossel de Instagram slide-a-slide (roteiro + caption + recomendação visual) na identidade Infuser
argument-hint: "[contexto opcional]"
---
Comando `/carrossel` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="carrossel".

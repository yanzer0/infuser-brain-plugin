---
description: Escreve a VSL (Video Sales Letter, roteiro de video de vendas 3-10min) na identidade Infuser
argument-hint: "[contexto opcional]"
---
Comando `/vsl` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="vsl".

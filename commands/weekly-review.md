---
description: Faz a revisão semanal do cérebro: feito vs planejado, progresso nos objetivos e projetos, padrões, ajustes e prioridades da próxima semana
argument-hint: "[contexto opcional]"
---
Comando `/weekly-review` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="weekly_review".

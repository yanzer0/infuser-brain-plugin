---
description: Gera a proposta comercial Infuser de um cliente (HTML dark self-contained: problema, solução em fases, prova/cases, ROI nos números dele, investimento, prazo...
argument-hint: "[contexto opcional]"
---
Comando `/proposta` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="proposta".

---
description: Registra uma saída/despesa no controle financeiro do cérebro (valor, categoria, destino, descrição)
argument-hint: "[contexto opcional]"
---
Comando `/saida` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="saida".

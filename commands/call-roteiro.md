---
description: Gera o CALL-CARD de uma call de venda (1 página: diagnóstico em 4 movimentos + preço + advance)
argument-hint: "[contexto opcional]"
---
Comando `/call-roteiro` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="call_roteiro".

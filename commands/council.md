---
description: Conselho de deliberação (orquestrador): roda uma decisão de alto risco por 5 lentes independentes (Cético, Primeiros-Princípios, Expansionista, Forasteiro, E...
argument-hint: "[contexto opcional]"
---
Comando `/council` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="council".

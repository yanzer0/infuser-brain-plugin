---
description: Pesquisa e qualifica um prospect contra o ICP da Infuser e cria/atualiza o card dele no pipeline (diagnóstico antes da venda, score honesto, recomendação Per...
argument-hint: "[contexto opcional]"
---
Comando `/prospect-research` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="prospect_research".

---
description: Elabora a minuta completa de um contrato da Infuser (B2B SaaS recorrente, prestação one-shot, NDA ou coprodução PJ), em markdown pronto pra revisão e assinatura
argument-hint: "[contexto opcional]"
---
Comando `/contrato` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="contrato".

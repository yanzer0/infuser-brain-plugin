---
description: Gera o briefing de um criativo de Meta Ads (formato + ângulo + hook + copy do anúncio + config de campanha) cruzando tráfego e copy
argument-hint: "[contexto opcional]"
---
Comando `/briefing-criativo` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="briefing_criativo".

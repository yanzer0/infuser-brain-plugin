---
description: Registra uma entrada/receita no controle financeiro do cérebro (parseia valor + categoria + origem, acha o bloco do mês, adiciona a linha, recalcula o total...
argument-hint: "[contexto opcional]"
---
Comando `/entrada` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="entrada".

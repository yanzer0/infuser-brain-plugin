---
description: Gera ideias de conteúdo alinhadas ao posicionamento e à persona (Reels, Carrossel, Post, Thread, Vídeo, Story)
argument-hint: "[contexto opcional]"
---
Comando `/content-idea` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="content_idea".

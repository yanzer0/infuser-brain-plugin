---
description: Roteia e responde qualquer demanda de tráfego pago Meta da Infuser (audita campanha, diagnostica CPA/CPM/CTR/ROAS, decide escalar/matar/pausar, estrutura con...
argument-hint: "[contexto opcional]"
---
Comando `/trafego` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="trafego".

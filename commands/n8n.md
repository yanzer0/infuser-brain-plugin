---
description: Builder de automação n8n end-to-end (PRD ate workflow publicado): faz perguntas pra especificar, gera o PRD completo, e com ele constroi + testa + publica o...
argument-hint: "[contexto opcional]"
---
Comando `/n8n` do seu Segundo Cérebro (Infuser). Argumento do usuário (se houver): "$ARGUMENTS".

1. Chame a tool `brain__command` com name="n8n".
